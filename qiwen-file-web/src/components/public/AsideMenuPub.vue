      ...
      >
        <el-submenu index="myFile" class="my-file">
          <template slot="title">
            ...
            <span slot="title">公共区域</span>
          </template>
          <el-menu-item
              index="0"
              :route="{ name: 'Public', query: { fileType: 0, filePath: '/' } }"
          >
          ...
          <el-menu-item
              index="1"
              :route="{ name: 'Public', query: { fileType: 1 } }"
          >
          ...
          <el-menu-item
              index="2"
              :route="{ name: 'Public', query: { fileType: 2 } }"
          >
          ...
          <el-menu-item
              index="3"
              :route="{ name: 'Public', query: { fileType: 3 } }"
          >
          ...
          <el-menu-item
              index="4"
              :route="{ name: 'Public', query: { fileType: 4 } }"
          >
          ...
          <el-menu-item
              index="5"
              :route="{ name: 'Public', query: { fileType: 5 } }"
          >
